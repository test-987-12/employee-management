        ...
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex md:items-center md:space-x-4">
            {user ? (
              ...
              <>
                <Link to="/auth" className="text-gray-700 hover:text-primary-500 font-medium">
                  Sign in
                </Link>
                <Link to="/auth" className="ml-8 inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary-600 hover:bg-primary-700">
                  Sign up
                </Link>
              </>
            )}
            ...
            {user ? (
              ...
              <div className="pt-4 pb-2 border-t border-gray-200 flex flex-col space-y-3">
                ...
                <Link
                  to="/auth"
                  onClick={() => setIsMobileMenuOpen(false)}
                  className="block py-2 text-base font-medium text-white bg-primary-600 hover:bg-primary-700 rounded px-4"
                >
                  Sign up
                </Link>
              </div>
